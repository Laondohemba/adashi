                ...
                <div class="card my-4 mx-auto" style="width: 35rem;">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <p class="card-text"><strong>Interval:</strong> {{ $userGroup->group->interval }} days
                                </p>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <p class="card-text"><strong>Membership status:</strong>
                                    {{ $userGroup->payment_status }}</p>
                            </div>
                            @if ($userGroup->status == 'Approved')
                                <div class="col-sm-12 my-3">
                                    ...
                                    <form action="{{ route('group.contribute', $userGroup->group) }}" method="post">
                                        @csrf
                                        <small class="text-muted">Input the round you want to contribute for e.g
                                            1</small>
                                        @error('round')
